...
//
void walk_on_sphere(const Eigen::MatrixXd& V, const Eigen::MatrixXi& F, const std::function<float(Eigen::Vector3d, double, bool)> u_hat, const Eigen::Vector3d& x0, double& u);
